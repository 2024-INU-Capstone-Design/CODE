...
while True:
    ...
    #홈플레이트 좌표 찍는 키키
        ...
        offset_point = ((left_point[0] + right_point[0])/2,  (left_point[1] + right_point[1])/2,  (left_point[2] + right_point[2])/2)
        ...
        for point1, point2 in zip(ball_trace_1, ball_trace_2):
                ...
                points = (points[0] - offset_point[0], points[1] - offset_point[1], points[2] - offset_point[2])
