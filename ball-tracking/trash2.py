...
# 비디오 파일 불러오기
video_path = 'C:/Users/ASUS/OneDrive/바탕 화면/realtime/ipcam_hyeonseocam_baseball_tracking.mp4'  # 여기에서 테스트할 비디오 파일 경로를 입력하세요.
...
# 현서 캠
initial_roi_x, initial_roi_y, initial_roi_width, initial_roi_height = 400, 50, 200, 200
...
while cap.isOpened():
    ...
    _, roi_thresh = cv2.threshold(blurred, 2, 255, cv2.THRESH_BINARY)
