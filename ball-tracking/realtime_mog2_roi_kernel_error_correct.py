...
while True:
    ...
    #홈플레이트 좌표 찍는 키키
        ...
        error1 = 1.3 + angle1_az_deg_homplate - angle1_az_left
        ...
        error2 = -0.9 - angle2_az_deg_homplate + angle2_az_left
        angle2_az_right, angle2_el_right = compute_angles('right',[homeplate_points_1[1]])
        left_point = calculate_3d_points(angle1_az_deg_homplate, angle1_az_left + error1, angle2_az_deg_homplate, angle2_az_left + error2,angle1_el_deg_homeplate,angle1_el_left)
        right_point = calculate_3d_points(angle1_az_deg_homplate, angle1_az_right + error1, angle2_az_deg_homplate, angle2_az_right + error2,angle1_el_deg_homeplate,angle1_el_right)
        ...
        for point1, point2 in zip(ball_trace_1, ball_trace_2):
                ...
                points = calculate_3d_points(angle1_az_deg_homplate, angle1_az_deg_baseball + error1, angle2_az_deg_homplate, angle2_az_deg_baseball + error2,angle1_el_deg_homeplate,angle1_el_deg_baseball)
