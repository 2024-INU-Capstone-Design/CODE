...
while cap.isOpened():
    ...
    for contour in contours:
        ...
        if area > 10 and 0.5 <= aspect_ratio <= 2.0:
            ...
            if previous_global_cx is None or global_cx >= previous_global_cx:
    ...
    # FPS에 따른 딜레이 설정 (ESC 키를 누르면 종료)
    delay = int(1000 / fps)  # FPS에 기반한 딜레이 계산
